#Ezio416 fork of "Minesweeper but you can't lose" by Thebrowndot (crammed version)    Forked: 2022-08-18     Modified: 2022-08-20
import numpy as np, random, time, pygame
...
def blowup(x, y):
    ...
    is_clock = True
    is_gameover = True
    if play_sound: mixer.Sound('blast.wav').play()
def board_update():
    global board_config
    for a in range(1, 31):
        for b in range(1, 17):
        ...
        for y in range(120, WINDOW_HEIGHT, blockSize):
            ...
            if x <= mouse_pos[0] <= x + blockSize and y <= mouse_pos[1] <= y + blockSize:
                if is_mouse == 1:
                    is_mouse += 1
                    place_mine()
                    no_mine_array = [(a - 1, b + 1), (a, b + 1), (a + 1, b + 1), (a - 1, b), (a, b), (a + 1, b), (a - 1, b - 1), (a, b - 1), (a + 1, b - 1)]
...
def mine_check(a, b) -> None:
    global flag
    flag = 0
    tuples = [(a - 1, b - 1), (a - 1, b + 1), (a + 1, b + 1), (a + 1, b - 1), (a, b - 1), (a, b + 1), (a + 1, b), (a - 1, b)]
